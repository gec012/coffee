...
export default function OrderCard({ order }: OrderCardProduct) {
    ...
    return (
        ...
        >
            ...
            <form action={completeOrder}>
                ...
                <input
                    type="submit"
                    className="bg-sky-600 hover:bg-sky-800 text-white w-full mt-5 p-3 uppercase font-bold cursor-pointer"
